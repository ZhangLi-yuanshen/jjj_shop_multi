  ...
  <el-dialog title="超链接设置" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false" :close-on-press-escape="false">
    ...
    <el-tabs type="border-card" v-model="activeName">
      <el-tab-pane label="产品" name="product">
        <ProductIndex v-if="activeName == 'product'" @changeData="activeDataFunc"></ProductIndex>
      </el-tab-pane>
    </el-tabs>
...
.setlink-footer-btn{ width: 160px;display: flex;position: absolute;right: -33px;top: 0;}
