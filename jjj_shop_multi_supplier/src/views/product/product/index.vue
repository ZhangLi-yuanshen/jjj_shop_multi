    ...
    <div class="common-seach-wrap">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="库存紧张" name="stock">
          <span slot="label">库存紧张 <el-tag size="mini">{{productCount.stock}}</el-tag></span>
        </el-tab-pane>
        <el-tab-pane label="草稿箱" name="draft">
          <span slot="label">草稿箱 <el-tag size="mini">{{productCount.draft}}</el-tag></span>
        </el-tab-pane>
      ...
      <div class="table-wrap">
        <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column fixed="right" label="操作" width="80">
            <template slot-scope="scope" v-if="supplierStatus==0">
              <div class="table-btn-column">
               <el-button @click="editClick(scope.row)" type="text" size="small" v-auth="'/product/product/edit'">编辑商品</el-button>
                ...
                <el-button v-if="activeName == 'sell'" @click="changeStatus(scope.row, 20)" type="text" size="small" v-auth="'/product/product/edit'">立即下架</el-button>
                <el-button v-if="activeName == 'lower'" @click="changeStatus(scope.row, 10)" type="text" size="small" v-auth="'/product/product/edit'">立即上架</el-button>
