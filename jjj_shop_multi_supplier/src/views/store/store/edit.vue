  ...
  <div class="product-add">
    ...
    <el-form size="small" ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label="门店区域">
        ...
        <el-select v-if="form.provinceId!=''" v-model="form.cityId" placeholder="市" @change="initRegion">
      ...
      getData () {
        ...
        StoreApi.shopDetail({
          ...
          .then(res => {
            ...
            self.form.is_check = res.data.store.isCheck;
