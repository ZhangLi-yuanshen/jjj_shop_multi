<template>
  <!--
      ...
      -->
  <div>
    <div class="common-level-rail"><el-button size="small" type="primary" icon="el-icon-plus" @click="addAd">添加广告</el-button></div>
    <div class="table-wrap">
      <el-table :data="tableData" style="width: 100%" v-loading="loading">
        ...
        <el-table-column prop="address" label="广告图" width="250">
          <template slot-scope="scope">
            <img v-img-url="'filePath',scope.row" width="100" height="100" />
          </template>
        </el-table-column>
