...
public class OrderRefundServiceImpl extends BaseServiceImpl<OrderRefundMapper, OrderRefund> implements OrderRefundService {
    ...
    public Paging<OrderRefundListVo> getList(OrderRefundPageParam orderRefundPageParam) {
        ...
        if(orderRefundPageParam.getShopSupplierId() != null && orderRefundPageParam.getShopSupplierId() > 0) {
            wrapper.eq(OrderRefund::getShopSupplierId, orderRefundPageParam.getShopSupplierId());
        }
    ...
    public Boolean apply(OrderRefundParam orderRefundParam) {
        ...
        Order order = orderService.getById(orderProduct.getOrderId());
        OrderRefund orderRefund = new OrderRefund();
        orderRefund.setShopSupplierId(order.getShopSupplierId());
     ...
     * @return
     */
    public Boolean plateApply(Integer orderRefundId) {
        return this.update(new LambdaUpdateWrapper<OrderRefund>()
                .eq(OrderRefund::getOrderRefundId, orderRefundId)
                .set(OrderRefund::getPlateStatus, 10));
    }
