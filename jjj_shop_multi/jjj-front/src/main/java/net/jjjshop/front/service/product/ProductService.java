...
public interface ProductService extends BaseService<Product> {
     ...
     * @return
     */
    List<SupplierBuyVo> getOrderProductListByNow(OrderBuyParam masterOrderBuyParam);
     ...
     * @return
     */
    List<SupplierBuyVo> getOrderProductListByCart(User user, OrderBuyParam orderBuyParam);

    /**
     * 商品上下架
     */
    Boolean editStatus(Integer productId, Integer productStatus);
