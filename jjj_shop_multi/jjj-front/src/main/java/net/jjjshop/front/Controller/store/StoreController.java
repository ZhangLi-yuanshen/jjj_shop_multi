...
public class StoreController extends BaseController {
    ...
    public ApiResult<List<StoreVo>> lists(String longitude, String latitude, Integer shopSupplierId) throws Exception{
        return ApiResult.ok(storeService.getAllCheck(longitude, latitude, shopSupplierId));
    }
}
