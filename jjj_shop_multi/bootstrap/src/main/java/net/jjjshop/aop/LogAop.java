...
//        }
//        // 记录supplier端日志
//        if(requestInfo.getPath().startsWith("/api/supplier/")){
//            // 异步保存操作日志
//            super.saveSupplierOperationLog(requestInfo, operationLogInfo, result, exception);
//            // 异步保存登录日志
//            super.saveSupplierLoginLog(requestInfo, operationLogInfo, result, exception);
//        }
//    }
//
//}
