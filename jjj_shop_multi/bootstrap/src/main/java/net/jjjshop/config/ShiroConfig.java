...
public class ShiroConfig {
    ...
    public JwtRealm jwtRealm(AdminLoginRedisService adminLoginRedisService, ShopLoginRedisService shopLoginRedisService,
                             SupplierLoginRedisService supplierLoginRedisService) {
        JwtRealm jwtRealm = new JwtRealm(adminLoginRedisService, shopLoginRedisService, supplierLoginRedisService);
    ...
    public SecurityManager securityManager(AdminLoginRedisService adminLoginRedisService, ShopLoginRedisService shopLoginRedisService,
        ...
        securityManager.setRealm(jwtRealm(adminLoginRedisService, shopLoginRedisService, supplierLoginRedisService));
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager,
        ...
        Map<String, Filter> filterMap = getFilterMap(shiroLoginService, adminLoginRedisService, shopLoginRedisService,
                supplierLoginRedisService, jwtProperties);
    ...
    private Map<String, Filter> getFilterMap(ShiroLoginService shiroLoginService,
        ...
        filterMap.put(JWT_FILTER_NAME, new JwtFilter(shiroLoginService, adminLoginRedisService,
                shopLoginRedisService, supplierLoginRedisService, jwtProperties));
        return filterMap;
    }
    ...
    public Authenticator authenticator(AdminLoginRedisService adminLoginRedisService, ShopLoginRedisService shopLoginRedisService,
        ...
        authenticator.setRealms(Arrays.asList(jwtRealm(adminLoginRedisService, shopLoginRedisService, supplierLoginRedisService)));
