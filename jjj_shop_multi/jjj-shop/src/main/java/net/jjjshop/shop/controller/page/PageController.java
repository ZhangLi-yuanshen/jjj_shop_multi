...
public class PageController {
    ...
    @RequestMapping(value = "/bottomnav", method = RequestMethod.GET)
    @RequiresPermissions("/page/page/bottomnav")
    @OperationLog(name = "bottomnav")
    @ApiOperation(value = "bottomnav", response = String.class)
    public ApiResult<JSONObject> bottomnav() throws Exception{
