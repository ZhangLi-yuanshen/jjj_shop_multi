...
import net.jjjshop.supplier.service.product.ProductCommentImageService;
...
public class ProductCommentServiceImpl extends BaseServiceImpl<ProductCommentMapper, ProductComment> implements ProductCommentService {
    ...
    public Map<String, Object> getList(CommentPageParam commentPageParam) {
        ...
        wrapper.eq(ProductComment::getShopSupplierId, commentPageParam.getShopSupplierId());
        ...
        Integer num = this.getNum(commentPageParam.getShopSupplierId());
     ...
     * @return
     */
    private Integer getNum(Integer shopSupplierId) {
    ...
    public Boolean edit(CommentParam commentParam){
        ...
        supplierUtils.updateScore(comment.getShopSupplierId());
        return update;
    }
