package net.jjjshop.supplier.service.file.impl;
...
import net.jjjshop.supplier.param.file.UploadFilePageParam;
import net.jjjshop.supplier.service.file.UploadFileService;
import net.jjjshop.supplier.vo.file.UploadFileVo;
...
public class UploadFileServiceImpl extends BaseServiceImpl<UploadFileMapper, UploadFile> implements UploadFileService {
    ...
    public Paging<UploadFileVo> getList(UploadFilePageParam uploadFilePageParam){
        ...
        wrapper.eq(UploadFile::getShopSupplierId, SupplierLoginUtil.getShopSupplierId());
