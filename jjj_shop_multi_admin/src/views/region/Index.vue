    ...
    <div class="common-seach-wrap">
      <el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
        ...
        <el-form-item label="选择上级">
          <el-select v-model="searchForm.provinceId" placeholder="省" @change="initCity">
            <el-option label="全部" value=""></el-option>
            <el-option :label="item.name" :value="item.id" v-for="(item,index) in areaList" :key='index'></el-option>
          </el-select>
          <el-select v-if="searchForm.provinceId!=''" v-model="searchForm.cityId" placeholder="市">
            <el-option label="全部" value=""></el-option>
            <el-option :label="item1.name" :value="item1.id" v-for="(item1,index1) in cityList"
              :key='index1'></el-option>
          </el-select>
        </el-form-item>
        <el-form-item><el-button size="large"  type="primary" icon="Search" @click="onSubmit">查询</el-button></el-form-item>
      </el-form>
    </div>
    <!--添加等级-->
    ...
    <div class="product-content">
      <div class="table-wrap">
        <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column prop="mergerName" label="名称"></el-table-column>
