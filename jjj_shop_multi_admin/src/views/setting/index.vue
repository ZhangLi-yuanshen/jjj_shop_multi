<template>
  ...
  <div class="product-add">
    ...
    <el-form size="small" ref="form" :model="form" label-width="150px">
      ...
      <el-form-item label="供应商系统名称" :rules="[{required: true,message: ' '}]" prop="supplierName">
        <el-input v-model="form.supplierName" placeholder="供应商系统名称" class="max-w460"></el-input>
        <el-col class="tips">
          供应商端名称，显示在登录页
        </el-col>
      </el-form-item>
      <el-form-item label="供应商登录背景" prop="supplierBgImg">
        <el-input v-model="form.supplierBgImg" placeholder="供应商登录背景" class="max-w460"></el-input>
        <el-col class="tips">
