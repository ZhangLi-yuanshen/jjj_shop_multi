...
import {delCookie,getCookie,deleteSessionStorage} from '@/utils/base.js';
...
{
    //在发送请求之前做某件事
    if (url != '/shop/file.upload/image'
        && url != '/shop/order.operate/batchDelivery') {
