...
<!--        <div class="tips">使用文本编辑器打开apiclient_key.pem文件，将文件的全部内容复制进来</div>-->
      ...
      <el-form-item label="支付宝 appid">
        <el-input v-model="form.alipayAppid" class="max-w460"></el-input>
      </el-form-item>
      <el-form-item label="支付宝公钥">
        <el-input type="textarea" :rows="4" v-model="form.alipayPublickey" class="max-w460"></el-input>
      </el-form-item>
      <el-form-item label="应用私钥">
        <el-input type="textarea" :rows="4" v-model="form.alipayPrivatekey" class="max-w460"></el-input>
      </el-form-item>
      <!--提交-->
