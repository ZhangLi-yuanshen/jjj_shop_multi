<template>
  <div class="product-list">
    ...
    <div class="common-seach-wrap">
      <el-tabs v-model="activeName" @tab-change="handleClick">
        <el-tab-pane label="出售中" name="sell">
          <template #label>
          <span >出售中 <el-tag size="mini">{{productCount.sell}}</el-tag></span>
          </template>
        </el-tab-pane>
        <el-tab-pane label="仓库中" name="lower">
          <template #label>
          <span >仓库中 <el-tag size="mini">{{productCount.lower}}</el-tag></span>
          </template>
        </el-tab-pane>
        <el-tab-pane label="回收站" name="recovery">
            <template #label>
          <span >回收站 <el-tag size="mini">{{productCount.recovery}}</el-tag></span>
          </template>
        </el-tab-pane>
        <el-tab-pane label="待审核" name="audit">
          <template #label>
          <span >待审核 <el-tag size="mini">{{productCount.audit}}</el-tag></span>
          </template>
        </el-tab-pane>
        <el-tab-pane label="未通过" name="noAudit">
           <template #label>
          <span >未通过 <el-tag size="mini">{{productCount.noAudit}}</el-tag></span>
          </template>
        </el-tab-pane>
      </el-tabs>
    ...
    <div class="common-level-rail" v-if="activeName == 'recovery'">
      <el-button size="small" type="primary" v-auth="'/product/product/add'" @click="allDelClick()">一键删除</el-button>
    </div>
            ...
            <template  #default="scope">
              <div class="product-info">
                ...
                <div class="info">
                  ...
                  <div class="price" v-if="activeName == 'noAudit'">未通过原因：{{ scope.row.auditRemark }}</div>
                </div>
              </div>
            </template>
          </el-table-column>
          <el-table-column prop="categoryName" label="分类"></el-table-column>
          <el-table-column prop="supplierName" label="所属店铺"></el-table-column>
