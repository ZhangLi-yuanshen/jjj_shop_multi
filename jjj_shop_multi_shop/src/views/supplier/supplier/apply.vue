  ...
  <div class="user clearfix">
    <div class="common-seach-wrap fr">
      <el-form size="small" :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item label="">
          <el-input v-model="formInline.storeName" placeholder="请输入店铺名称"></el-input>
        </el-form-item>
    ...
    <div class="product-content">
      <div class="table-wrap">
        <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
          <el-table-column prop="supplierApplyId" label="申请ID" width="90"></el-table-column>
          <el-table-column prop="" label="会员昵称" ><template  #default="scope">
          ...
          <el-table-column label="营业执照" width="80">
            <template  #default="scope" >
                <el-image v-if="scope.row.businessImage" :src="scope.row.businessImage"
                  :width="50" :height="50" :preview-src-list="getSrcList(scope.$index)"/>
            </template>
          </el-table-column>
          <el-table-column prop="mobile" label="手机号码"></el-table-column>
          <el-table-column prop="userName" label="姓名"></el-table-column>
          <el-table-column prop="" label="主营类别"><template  #default="scope">
