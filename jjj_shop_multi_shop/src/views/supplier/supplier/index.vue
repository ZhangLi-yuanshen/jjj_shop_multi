<template>
  ...
  <div class="user clearfix">
    ...
    <div class="common-level-rail fl">
      <el-button size="small" type="primary" icon="Plus" @click="addClick" v-auth="'/supplier/supplier/add'">添加商户</el-button>
    </div>
    ...
    <div class="product-content">
      <div class="table-wrap">
        <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column prop="shopSupplierId" label="商户ID" width="90"></el-table-column>
          <el-table-column prop="name" label="商户名称"></el-table-column>
          <el-table-column prop="userName" label="登录账号"></el-table-column>
          <el-table-column label="logo" width="80">
            <template  #default="scope">
              <el-image v-if="scope.row.logoId" :src="scope.row.logoFilePath"
                :width="50" :height="50" :preview-src-list="getLogoList(scope.$index)"/>
            </template>
          </el-table-column>
          <el-table-column label="营业执照" width="80">
            <template  #default="scope">
              <el-image v-if="scope.row.businessId" :src="scope.row.businessFilePath"
          ...
          <el-table-column prop="linkName" label="联系人" width="90"></el-table-column>
          ...
          <el-table-column fixed="right" label="操作" width="150">
            <template  #default="scope">
              <el-button @click="recycle(scope.row,0)" type="text" size="small" v-auth="'/supplier/supplier/edit'" v-if="scope.row.isRecycle==1" style="color:gray;">开启</el-button>
              ...
              <el-button @click="deleteClick(scope.row.shopSupplierId)" type="text" size="small" v-auth="'/supplier/supplier/delete'">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
