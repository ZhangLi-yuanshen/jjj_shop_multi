<template>
  ...
  <div class="product-add">
    ...
    <el-form size="small" ref="form" :model="form" label-width="200px">
      ...
      <el-form-item label="账号" prop="supplier.userName" :rules="[{required: true,message: ' '}]">
        <el-input class="max-w460" v-model="form.supplier.userName" placeholder="请输入账号"></el-input>
       </el-form-item>
      ...
      <el-form-item label="确认密码" prop="supplier.confirmPassword" :rules="[{required: true,message: ' '}]">
        <el-input v-model="form.supplier.confirmPassword" placeholder="请输入确认密码" type="password" class="max-w460"></el-input>
      </el-form-item>
      <el-form-item label="联系人" prop="supplier.linkName" :rules="[{required: true,message: ' '}]">
        <el-input class="max-w460" v-model="form.supplier.linkName" placeholder="请输入联系人"></el-input>
      </el-form-item>
      <el-form-item label="联系电话" prop="supplier.linkPhone" :rules="[{required: true,message: ' '}]">
        <el-input class="max-w460" v-model="form.supplier.linkPhone" placeholder="请输入联系电话"></el-input>
      </el-form-item>
      ...
      <el-form-item label="主营类别" prop="supplier.categoryId" :rules="[{required: true,message: ' '}]">
        <el-select v-model="form.supplier.categoryId" placeholder="请选择">
          <el-option v-for="(item, index) in category" :key="index" :label="item.name" :value="item.categoryId"></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="营业执照">
        <el-row>
          <el-button icon="Picture" @click="openUpload('business')">选择图片</el-button>
