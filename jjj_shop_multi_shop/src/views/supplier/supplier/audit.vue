  ...
  <div class="product-add">
    ...
    <el-form size="small" ref="form" :model="form" label-width="200px">
      ...
      <el-form-item label="店铺名称" prop="supplier.storeName">
        <el-input class="max-w460" v-model="form.supplier.storeName" placeholder="请输入店铺名称" :disabled="true"></el-input>
      </el-form-item>
      ...
      <el-form-item label="姓名" prop="supplier.userName">
        <el-input v-model="form.supplier.userName" placeholder="姓名" type="text" class="max-w460" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="营业执照:">
        <el-row>
          <div v-if="form.supplier.businessId!=0" class="img">
            <el-image :src="form.supplier.businessImage" style="width: 100px; height: 100px"
            :preview-src-list="srcList"/>
          </div>
        </el-row>
      </el-form-item>
      <el-form-item label="主营类别" prop="supplier.categoryId">
        <el-input class="max-w460" v-model="form.supplier.categoryName" :disabled="true"></el-input>
      </el-form-item>
