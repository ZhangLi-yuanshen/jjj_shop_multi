          ...
          <div class="d-b-s">
            ...
            <div class="flex-1">
              <div class="">
                <div class="f12">
                  <div>
                    <span v-if="item.style.show.assemblePrice" style="color:#f6220c;" class="f12">¥</span><span
                      style="color:#f6220c;" class="f16 fb" v-if="item.style.show.assemblePrice">233.00</span>
                  </div>
                  <div v-if="item.style.show.linePrice" class="text-d-line-through gray9">¥233</div>
                </div>
              </div>
