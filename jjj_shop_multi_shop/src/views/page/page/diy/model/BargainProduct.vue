<template>
  ...
  <div class="drag optional " :class="{ selected: index === selectedIndex }"
    ...
    <div class="diy-sharpproduct" :style="{ background: item.style.background }">
      <div class="sharpproduct-head d-b-c" :style="'background: url('+item.style.backgroundImage+');'">
        <div class="left d-s-c">
          <div class="name"> </div>
          <div class="datetime d-s-c">
            <div class="daybox hour"
              :style="{ background: item.style.countdownBackColor,color: item.style.countdownColor}">12天</div>
        ...
        <li class="product-item" v-for="(product, index) in item.data" :key="index">
          ...
          <div class="product-info p-0-10">
            <div class="price d-b-c f12 tc">
              <div>
                <div v-if="item.style.show.floorPrice" class="red">¥120</div>
                <div v-if="item.style.show.originalPrice" class="gray6 text-d-line">¥233</div>
              </div>
            </div>
          </div>
        </li>
