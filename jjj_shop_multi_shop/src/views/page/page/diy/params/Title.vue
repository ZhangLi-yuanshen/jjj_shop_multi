  ...
  <div>
    ...
    <el-form size="small" :model="curItem" label-width="100px">
      ...
      <el-form-item label="图标显示：">
        <el-radio-group v-model="curItem.params.showIcon">
      ...
      <el-form-item label="标题图标：">
        <div class="diy-notice-icon">
          <img v-img-url="curItem.params.icon" width="32" height="32" alt="" @click="$parent.onEditorSelectImage(curItem.params, 'icon')">
        </div>
        <div>建议尺寸32×32</div>
      </el-form-item>
      <!-- 公告内容 -->
