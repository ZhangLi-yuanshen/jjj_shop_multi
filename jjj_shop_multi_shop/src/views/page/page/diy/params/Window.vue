    ...
    <el-form size="small" :model="curItem" label-width="100px">
      ...
      <el-form-item label="图片：">
        <div class="param-img-item" :key="index" v-for="(imageSingle, index) in curItem.data">
          <div class="delete-box"><el-icon  @click="$parent.onEditorDeleleData(index, selectedIndex)"><DeleteFilled /></el-icon></div>
        ...
        <div class="ww100"><el-button @click="$parent.onEditorAddData">添加一个</el-button></div>
      </el-form-item>
    </el-form>
