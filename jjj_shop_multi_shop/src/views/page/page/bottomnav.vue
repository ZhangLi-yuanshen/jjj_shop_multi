      ...
      <el-form size="small" :model="formData" label-width="150px">
        ...
        <el-form-item :label="navBar.text+':'" :key="index" v-for="(navBar, index) in formData.list">
          <div class="param-img-item">
            <div class="d-e-c"><el-icon class="Delete-solid" @click="onEditorDeleleData(index)"><DeleteFilled /></el-icon></div>
            <div class="d-a-c">
              <div class="icon">未选中：
          ...
          <div class="d-s-c mb16">
            <div class="url-box flex-1 d-s-c">
              ...
              <el-input disabled v-model="navBar.linkUrl"></el-input>
            </div>
  ...
  export default {
    ...
    methods: {
      ...
      Submit() {
        ...
        PageApi.editTabbar(Params, true)
          .then(data => {
            self.loading = false;
            ElMessage({
              message: '恭喜你，修改成功',
      ...
      closeLinkset(e) {
        ...
        this.formData.list[this.index].linkUrl = '/' + e.url;
