<template>
  ...
  <div class="product-add">
    ...
    <el-form size="small" ref="form" :model="form" label-width="150px">
      ...
      <el-form-item label="抽成百分比(%)" :rules="[{required: true,message: ' '}]" prop="commissionRate">
        <el-input v-model="form.commissionRate" placeholder="抽查比例" class="max-w460" type="number"
      ...
      <el-form-item label="服务协议" :rules="[{required: true,message: ' '}]" prop="policy.service">
        ...
        <div class="tips">进入app和登录、注册页面显示
        </div>
      </el-form-item>
