    ...
    <div class="product-content">
      <div class="table-wrap">
        <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
          <el-table-column prop="messageTypeText" label="所属"></el-table-column>
          <el-table-column prop="messageName" label="通知名称"></el-table-column>
          <el-table-column prop="remark" label="推送规则"></el-table-column>
          <el-table-column label="公众号通知" v-if="message_to == 10">
            <template  #default="scope">
              <el-checkbox v-model="scope.row.mpStatus" @change="checked=>mpStatusChange(checked, scope.row)">启用</el-checkbox>
          ...
          <el-table-column label="小程序通知" v-if="message_to == 10">
            <template  #default="scope">
              <el-checkbox v-model="scope.row.wxStatus" @change="checked=>wxStatusChange(checked, scope.row)">启用</el-checkbox>
          ...
          <el-table-column label="短信通知">
            <template  #default="scope">
              <el-checkbox v-model="scope.row.smsStatus" @change="checked=>smsStatusChange(checked, scope.row)">启用</el-checkbox>
