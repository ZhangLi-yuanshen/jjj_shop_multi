      ...
      <div class="table-wrap">
        ...
        <div>
          <el-form-item label="模板id：">
            <el-input size="small" class="max-w460" v-model="templateId" placeholder="请填写申请的公众号模板消息id"></el-input>
          </el-form-item>
        </div>
        <el-table border ref="fieldTable" :data="fieldList" @selection-change="handleSelectionChange" v-loading="loading">
          ...
          <el-table-column label="模板变量名">
            <template  #default="scope">
              <el-input size="small" prop="fieldNewEname" v-model="scope.row.fieldNewEname"></el-input>
            </template>
          </el-table-column>
          <el-table-column label="模板内容">
            <template  #default="scope">
              <el-input size="small" prop="filedNewValue" :disabled="scope.row.isVar === 1" v-model="scope.row.filedNewValue"></el-input>
            </template>
          </el-table-column>
        </el-table>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      initChecked: function() {
        ...
        console.log(self.settings.varData);
