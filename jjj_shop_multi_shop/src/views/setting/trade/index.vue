  ...
  <div class="product-add">
    ...
    <el-form size="small" ref="form" :model="form" label-width="150px">
      ...
      <el-form-item label="未支付订单">
        <el-input v-model="form.closeDays" type="number" style="width: 200px;"></el-input>
        <el-select size="small" v-model="form.closeType"  type="number" style="width: 80px;"  >
          <el-option v-for="item in closeTypeList" :key="item.closeType" :label="item.name" :value="item.closeType">
          </el-option>
        </el-select>
        后自动关闭
        <div class="tips">
      ...
      <el-form-item label="运费组合策略">
        ...
        <div style="margin-top: 20px">
          <el-radio v-model="form.freightRule" :label="20">已低运费结算</el-radio>
          <el-col class="tips">
            订单中的商品有多个运费模板时，取订单中运费最少的商品的运费计为订单总运费
          </el-col>
        </div>
        <el-col style="margin-top: 20px">
          <el-radio v-model="form.freightRule" :label="30">已高运费结算</el-radio>
          <div class="tips">
        ...
        SettingApi.tradeDetail({}, true)
          .then(res => {
             if (res.code == 1) {
              ...
              self.form.closeType = vars.closeType;
            }
          })
          .catch(error => {
