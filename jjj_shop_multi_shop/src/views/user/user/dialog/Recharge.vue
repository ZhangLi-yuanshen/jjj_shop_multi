<template>
  ...
  <el-dialog title="会员充值" v-model="dialogVisible" @close='dialogFormVisible' :close-on-click-modal="false"
      ...
      <el-tab-pane label="充值余额" name="first">
        <el-form size="small" :model="form">
          ...
          <el-form-item label="变更金额" :label-width="formLabelWidth">
            <el-input v-model="recharge.money" autocomplete="off" placeholder="请输入变更金额"></el-input>
          </el-form-item>
          <el-form-item label="管理员备注" :label-width="formLabelWidth">
            <el-input type="textarea" v-model="recharge.balanceRemark" placeholder="请输入管理员备注"></el-input>
          </el-form-item>
        </el-form>
      </el-tab-pane>
      <el-tab-pane label="充值积分" name="second">
        <el-form size="small" :model="form">
          ...
          <el-form-item label="变跟数量" :label-width="formLabelWidth">
            <el-input v-model="recharge.value" autocomplete="off" placeholder="请输入变更数量"></el-input>
          </el-form-item>
          <el-form-item label="管理员备注" :label-width="formLabelWidth">
            <el-input type="textarea" v-model="recharge.pointsRemark" placeholder="请输入管理员备注"></el-input>
          </el-form-item>
        </el-form>
      </el-tab-pane>
    </el-tabs>
    ...
    <div  class="dialog-footer">
      ...
      <el-button type="primary" @click="addUser(form.userId)" :loading="loading">确 定</el-button>
    </div>
    </template>
  </el-dialog>
</template>
