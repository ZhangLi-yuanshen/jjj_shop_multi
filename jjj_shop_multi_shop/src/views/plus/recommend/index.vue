    ...
    <el-form size="small" ref="form" :model="form" label-width="100px">
      ...
      <el-form-item size="small" label="" v-if="form.choice == 1">
        <div class="common-level-rail">
          <el-button size="small" icon="el-icon-plus" @click="addClick">添加商品</el-button>
        </div>
        <div class="pb50">
  ...
  export default {
    ...
    methods: {
      ...
      closeProductDialogFunc (e) {
        ...
        if (e.type == 'success') {
          if (this.product_arr.indexOf(e.params.productId) > -1) {
            this.$message({
              message: '你已选中该产品',
              type: 'error'
            });
      ...
      /*删除商品*/
      deleteClick (e) {
        let index = this.product_arr.indexOf(e.productId);
