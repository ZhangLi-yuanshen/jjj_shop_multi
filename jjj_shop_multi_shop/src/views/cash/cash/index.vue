    ...
    <div class="cash cash_t_common cash_t_brief">
      ...
      <div class="cash-body">
        <div class="content">
          ...
          <p class="money">{{ tj_data.totalMoney }}</p>
        </div>
        <div class="content">
          <p class="title">供应商订单销售总金额（元）</p>
          <p class="money">{{ tj_data.supplierMoney }}</p>
        </div>
        <div class="content">
          <p class="title">平台订单抽成（元）</p>
          <p class="money">{{ tj_data.sysMoney }}</p>
        </div>
      </div>
    </div>
    <div class="cash cash_t_common cash_t_brief">
      ...
      <div class="cash-body">
        <div class="content">
          ...
          <p class="money">{{ supplier_data.totalMoney }}</p>
        </div>
        <div class="content">
        ...
        <div class="content">
          ...
          <p class="money">{{ supplier_data.freezeMoney }}</p>
        </div>
        <div class="content">
