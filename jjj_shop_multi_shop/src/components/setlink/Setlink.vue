<template>
  <!--
        ...
        描述：超链接选择
    -->
  <el-dialog title="超链接设置" v-model="dialogVisible" @close="dialogFormVisible" 
    ...
    <el-tabs type="border-card" v-model="activeName">
      ...
      <el-tab-pane label="产品" name="product"><Productindex v-if="activeName == 'product'" @changeData="activeDataFunc"></Productindex></el-tab-pane>
